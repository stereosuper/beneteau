	...
	<svg width='0' height='0' style='position:absolute;z-index:-10'>
		<defs>
			...
			<symbol id="icon-fb" viewBox="0 0 16 32">
				<path d="M15.792 0v6.078h-2.909c-2.234 0-2.494 1.351-2.494 2.753v2.13h5.403l-0.52 6.597h-4.883v14.442h-6.597v-14.442h-3.792v-6.597h3.792v-4.831c0-3.948 2.234-6.13 6.597-6.13h5.403z"></path>
			</symbol>

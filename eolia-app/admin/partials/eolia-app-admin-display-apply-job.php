...
<form method="post" action="options.php">
	...
	?>
	<div id="jobapply_layout_component">
		...
		<div class="available_fields_area">
			...
			<ul class="availables_fields">
				<li class="field multiple_field" data-type="custom" data-component="title">
					<span class="field_label"> <span class="fa fa-fw fa-text-height"></span>Titre</span>
				...
				<li class="field multiple_field" data-type="custom" data-component="hr">
					<span class="field_label"> <span class="fa fa-fw fa-minus"></span>Separateur</span>
					<input type="button" data-id="hr" class="add_field button button-small"
					       value="<?= _x( 'Add to form', 'admin form builder button', $this->plugin_name ); ?>"
					       title="<?= _x( 'Click to add', 'admin form builder placeholder', $this->plugin_name ) ?>"/>
				</li>
				<li class="field multiple_field" data-type="custom" data-component="text">
					<span class="field_label"> <span class="fa fa-fw fa-align-left"></span>Texte</span>
					<input type="button" data-id="custom_txt" class="add_field button button-small"
					       value="<?= _x( 'Add to form', 'admin form builder button', $this->plugin_name ); ?>"
					       title="<?= _x( 'Click to add', 'admin form builder placeholder', $this->plugin_name ) ?>"/>
				</li>
			</ul>
		...
		<div class="selected_fields_area">
			...
			<script type="text/json"><?php
				$selected_fields = json_decode( $options['jobapply_layout'] );
				if ( $selected_fields ) {
					echo $options['jobapply_layout'];
				}
				?></script>
		</div>

	</div>
	<input type="hidden" id="<?php echo $this->plugin_name; ?>-jobapply_layout"
	       name="<?php echo $this->plugin_name; ?>[jobapply_layout]" value=""/>
